...
int main() {
	...
	cin >> nome;
	/* lou aqui, não implementei no codigo pra vc ver oq eu fiz primeiro e vc decidir ser vai implementar ou n, mas a ideia é essa, 
	a gente vai ler o nome da instrução e depois procurar na tabela R, I e J, caso encontre a instrução na tabela R, ele vai pegar o 
	opcode e o funct e os valores dos registradores e do shamt, caso encontre na tabela I ele vai pegar o opcode e os valores dos registradores 
	e do immediate, caso encontre na tabela J ele vai pegar o opcode e o valor do address, depois disso ele vai salvar a instrução no arquivo binário e 
